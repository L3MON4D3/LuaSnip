...
describe("luasnip.util.environ", function()
	...
	check_fails("Environ with invalid name", [[Environ.env_namespace("TES_T", {vars={AGE="120"}})]])
	check_fails("Environ with invalid name", [[Environ.env_namespace("TES_T", {vars={AGE="120"}})]])
	check_fails("Environ without opts", [[Environ.env_namespace("TES_T")]])
	check_fails("Environ without init or vars", [[Environ.env_namespace("TES_T", {})]])
	check_fails("Environ with eager but no vars", [[Environ.env_namespace("TES_T", {eager={"A"}})]])
	check_fails("Environ with multiline_vars incorrect type", [[Environ.env_namespace("TES_T", {var={A='s', multiline_vars = 9 }})]])
end)
