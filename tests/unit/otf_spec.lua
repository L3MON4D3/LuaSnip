...
describe("luasnip.extra.otf", function()
    ...
    check("Text and inputs",
          "local $val = require'module'.$color",
          { { "TXT", "local " }, { "INP", "val" }, { "TXT", " = require'module'." }, { "INP", "color" } })

    check("Multiline text with escapes",
          "$something is more important than $$\nbut you can have both --$someone",
          { { "INP", "something" }, { "TXT", " is more important than " }, { "TXT", "$" }, { "EOL" }, { "TXT", "but you can have both --" }, { "INP", "someone" } })
end )
